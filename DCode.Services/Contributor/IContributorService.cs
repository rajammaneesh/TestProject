...
namespace DCode.Services.Contributor
{
    public interface IContributorService
    {
        ...
        int ApplyTask(int taskId, string emailAddress, string statementOfPurpose, string proficiency);
        ...
        int ApplyFITask(int taskId,string requestor, string proficiency);
    }
}
