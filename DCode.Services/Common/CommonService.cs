        ...
        private List<MenuItem> FetchMenuItems(Role role)
        {
            ...
            switch (_userContext.Role)
            {
                ...
                case Role.Requestor:
                    ...
                    menuItemsList.Add(new MenuItem() { MenuItemName = "USER MANUAL", TabName = Constants.UserManual, NavigationUrl = "/Content/sample.pdf", ImageUrlActive = "/Content/Images/Email-Active.png", ImageUrlInactive = "/Content/Images/Email-Inactive.png", CssClass = "contactus-icon" }); break;
