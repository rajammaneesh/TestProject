...
namespace DCode.Data.ContributorRepository
{
    public interface IContributorRepository
    {
        ...
        IEnumerable<taskskill> GetFilteredTasks(List<string> skillFilters, string serviceLine, int selectedTaskType, string searchText, int currentPageIndex, int recordsCount, out int totalRecords);
