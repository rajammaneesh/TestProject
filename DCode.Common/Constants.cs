...
namespace DCode.Common
{
    public static class Constants
    {
        ...
        public static string DCodeNotification = "TX Notification";
        public static string DCodeNewFINotification = "New TX FI Task Notification {0}";
        public static string UseWindowsIdentity = "UseWindowsIdentity";
        public static string SmtpDeloitte = "smtp.deloitte.com";
        public static string AssignBody = "You are assigned to work on task - <b>{0}</b> under project - <b>{1}</b> for the offering <b>{4}</b>.<br/><br/>WBS Code for project {2} - {3}<br/><br/>Regards,<br/>TX Team";
        public static string ApproveRejectBody = "Your request to work on task - <b>{0}</b> under project - <b>{1}</b> for the offering <b>{3}</b> is <b>{2}</b>.<br/><br/>Regards,<br/>TX Team";
        public static string ReviewBody = "Your task - <b>{0}</b> under project - <b>{1}</b> for the offering - <b>{2}</b> is reviewed and closed.<br/><br/>Regards,<br/>TX Team";
        public static string ApplyBody = "<b>{0}</b> has requested to be assigned for <b>{1}</b> under project <b>{2}</b> from the <b>{5}</b> offering for <b>{3}</b> starting <b>{4}</b>.<br/>He/she requires your permission to get assigned on this task.<br/>Kindly approve.<br/><br/>Regards,<br/>TX Team";
        public static string ApplyFIBody = "<b>{0}</b> has requested to be assigned for the Firm Initiative <b>{1}</b> from the <b>{4}</b> offering for <b>{2}</b> hours starting <b>{3}</b>.<br/><br/>Regards,<br/>TX Team";
        public static string PostNewFIBody = "A New Firm Initiative <b>{0}</b> from the <b>{4}</b> offering has been added to the TX portal for <b>{1}</b> hours starting <b>{2}</b> by the lead (cc'ed).<br/><br/>Description {3} <br/><br/>Please apply for the task through TX <br/><br/>Regards,<br/>TX Team";
        public static string ClientServiceNotificationBody = "New Tasks have been added to the  <a href=\"http://techx/\">TX</a> portal for the <b>{0}</b> skillset.{1}<br/><br/>Regards,<br/>TX Team";
        public static string FirmInitiativeNotificationBody = "New Firm Initiatives have been added to the  <a href=\"http://techx/\">TX</a> portal for the offering <b>{1}</b>.{0}<br/><br/>Regards,<br/>TX Team";
        public static string CollectiveClientServiceTasksNotificationBody = "New Client Service Tasks have been added to the  <a href=\"http://techx/\">TX</a> portal for the <b>{1}</b> offering.{0}<br/><br/>Regards,<br/>TX Team";
