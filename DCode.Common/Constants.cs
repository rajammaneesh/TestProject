...
namespace DCode.Common
{
    public static class Constants
    {
        ...
        public static string AssignBody = "You are assigned to work on task - {0} under project - {1} for the offering {4}.<br/><br/>WBS Code for project {2} - {3}<br/><br/>Regards,<br/>TX Team";
        public static string ApproveRejectBody = "Your request to work on task - {0} under project - {1} for the offering {3} is {2}.<br/><br/>Regards,<br/>TX Team";
        ...
        public static string ApplyBody = "{0} has requested to be assigned for {1} under project {2} from the {5} offering for {3} starting {4}.<br/>He/she requires your permission to get assigned on this task.<br/>Kindly approve.<br/><br/>Regards,<br/>TX Team";
        public static string ApplyFIBody = "{0} has requested to be assigned for the Firm Initiative <b>{1}</b> from the <b>{4}</b> offering for {2} hours starting {3}.<br/><br/>Regards,<br/>TX Team";
        public static string PostNewFIBody = "A New Firm Initiative <b>{0}</b> from the <b>{4}</b> offering has been added to the TX portal for {1} hours starting {2} by the lead (cc'ed).<br/><br/>Description {3} <br/><br/>Please apply for the task through TX <br/><br/>Regards,<br/>TX Team";
        public static string ClientServiceNotificationBody = "New Tasks have been added to the  <a href=\"http://techx/\">TX</a> portal for the {0} skillset.{1}<br/><br/>Regards,<br/>TX Team";
        ...
        public static string CollectiveClientServiceTasksNotificationBody = "New Client Service Tasks have been added to the  <a href=\"http://techx/\">TX</a> portal for the {1} offering.{0}<br/><br/>Regards,<br/>TX Team";
